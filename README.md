...
special characters are integrated into the keyboard  here [`exegesis.json`](https://github.com/16thExegesisDH/HTR_Paul_corpus/blob/main/keyboard/exegesis.json) 
