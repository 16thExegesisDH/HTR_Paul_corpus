...
| Semicolon (shaped)   | <img src="https://github.com/FourbeFlo/Lambertus/blob/main/images/semi-colon%20shapped.png" alt="semi-colon" width="27" height="48"> ||                                          | <img src="pictures/mysteria_litterae/que_acute_semicolon.png" alt="que accentue" width="76" height="45">               | q `U+0071` + acute `U+0301` <br>  `Junicode (F1AC)`             |
